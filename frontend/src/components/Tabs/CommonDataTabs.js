    ...
    <Grid gap={5} templateColumns="repeat(1, 1fr)">
      ...
      <GridItem>
        <HStack p={2}>
          ...
          >
            {GENERAL_ASSESSMENT_CHOICES.map(({ value: value, name }, index) => (
        ...
        <HStack p={2}>
          ...
          >
            {CONSCIOUSNESS_CHOICES.map(({ value: value, name }, index) => (
              <option value={value} key={index}>
                {name}
              </option>
            ))}
        ...
        <HStack p={2}>
          ...
          >
            {BODY_POSITION_CHOICES.map(({ value: value, name }, index) => (
              <option value={value} key={index}>
                {name}
              </option>
            ))}
        ...
        <HStack p={2}>
          <Text align="start">
            ...
            <Input
              ...
              onChange={(e) => {
                handleChange("normal_blood_pressure_systolic", e.target.value);
              }}
            />
            /
            <Input
              ...
              onChange={(e) => {
                handleChange("normal_blood_pressure_diastolic", e.target.value);
              }}
            />
          </Text>
        </HStack>
