...
# Тестовые словари
CAUSES_TEST = ['Высокая температура, кашель', "Болит живот", "падение с высоты", 'головокружение', 'боль в пояснице']
COMPLAINTS_TEST = [
    "Острая боль в правом боку, тошнота, рвота.",
    "Головокружение и шум в ушах при резком вставании.",
    "Жжение за грудиной после приёма пищи.",
    "Припухлость и боль в коленном суставе по утрам.",
    "Учащённое мочеиспускание, жажда, потеря веса.",
    "Сухой кашель более трёх недель, одышка.",
    "Сыпь на локтях и коже головы, шелушение.",
    "Схваткообразные боли внизу живота перед менструацией.",
    "Онемение мизинца и безымянного пальца левой руки.",
    "Постоянная слабость, сонливость, зябкость без температуры."
    ]
ANAMNESIS_TEST = [
    "Заболел остро вчера вечером с подъёма температуры.",
    "Боль в горле появилась после употребления холодного напитка.",
    "Тошнота и рвота возникли через час после еды.",
    "Головная боль нарастала постепенно в течение недели.",
    "Кашель беспокоит около месяца, усиливается по утрам.",
    "Травму колена получил при падении два дня назад.",
    "Сыпь заметила утром после приёма нового лекарства.",
    "Одышка стала беспокоить после физической нагрузки вчера.",
    "Боль в пояснице возникла резко при поднятии тяжести.",
    "Слабость и утомляемость развивались медленно последние полгода."
]
LOCAL_STATUS_TEST = [
    "Зев гиперемирован, миндалины отёчны, налёта нет.",
    "Живот мягкий, болезненный в правой подвздошной области.",
    "Коленный сустав припухший, горячий на ощупь, движения ограничены.",
    "На коже груди пятнисто-папулёзная сыпь, не зудит.",
    "В лёгких жёсткое дыхание, сухие хрипы справа.",
    "Тоны сердца ритмичные, шумов нет, пульс 90.",
    "Язык обложен белым налётом, сухой.",
    "Шейные лимфоузлы увеличены до 1 см, безболезненны.",
    "Зрачки расширены, реакция на свет вялая.",
    "Поясничная область без деформации, болезненна при пальпации."
]
BOOLEAN_CHOICES_TEST = [True, False]
AID = [
    "Введён парацетамол внутривенно, жаропонижающее подействовало.",
    "Наложена давящая повязка, холод на место ушиба.",
    "Выполнена ингаляция с беродуалом, одышка уменьшилась.",
    "Промыт желудок, дан активированный уголь внутрь.",
    "Обработана рана антисептиком, наложен лейкопластырь.",
    "Измерено артериальное давление, зафиксирована гипертензия.",
    "Введён атропин подкожно, брадикардия купирована.",
    "Даны рекомендации по приёму ибупрофена при болях.",
    "ЭКГ записана, передана дежурному кардиологу на расшифровку.",
]
DIAGNOSIS_TEST = [
    ("J06.9", "Острая инфекция верхних дыхательных путей неуточненная"),
    ("I10", "Эссенциальная гипертензия"),
    ("K29.1", "Острый гастрит"),
    ("M17.9", "Остеоартроз коленного сустава неуточненный"),
